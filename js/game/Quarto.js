 ...
 * @param pieces
 */
var goFinish = function(bases, draw) {
    ...
    // Display win
    if(!draw){
        GUI.displayWin(QUARTO.players[QUARTO.currentPlayer-1].name);
    }else{
        GUI.displayDraw();
    }
...
var initEnvironment = function() {
    ...
    var skyboxMaterial = new BABYLON.StandardMaterial("skyBox", QUARTO.scene);
    skyboxMaterial.backFaceCulling = false;
    skyboxMaterial.diffuseColor = new BABYLON.Color3(0, 0, 0);
    skyboxMaterial.specularColor = new BABYLON.Color3(0, 0, 0);
    skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture("img/cloud/mysky", QUARTO.scene);
...
var switchPlayer = function() {
    QUARTO.nbTurn ++;
    QUARTO.currentPlayer = QUARTO.currentPlayer%2+1;
    // Display message
    GUI.setCurrentAction(QUARTO.currentPlayer, GUI.PUT_ACTION);
